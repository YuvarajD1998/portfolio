...
/**
 * CaseStudySection — the anchored movement wrapper (Sprint 07 §02, §21).
 *
 * Purpose:      Every case-study movement is an addressable, labelled seam the
 *               section rail and scroll-spy steer by (S07 §02, §21). This wraps
 *               one movement: an `id`ed `<section>` with a header (kicker + H2 +
 *               optional lead) and a stacked body, entering with the canonical
 *               Reveal. It keeps all 17 sections visually and structurally
 *               identical so the narrative reads as one document.
 ...
 * Composition:  Used once per movement on the Transpahire page, in narrative
 *               order; the `id` matches the section-rail anchor.
 */
